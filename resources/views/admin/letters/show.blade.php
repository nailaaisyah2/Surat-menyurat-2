    ...
    <div class="col-12">
        <div class="card shadow-sm border-0">
            ...
            <div class="card-body p-4">
                ...
                <div class="mb-4">
                    ...
                    <div>
                        ...
                        <span class="badge bg-warning fs-6 px-4 py-2">
                            <i class="bi bi-clock-history"></i> Pending - Menunggu Tanggapan
                        </span>
                ...
                <div class="mb-4">
                    ...
                    <div class="card bg-light border-0">
                        <div class="card-body">
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6 mb-2">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            <label class="text-muted small">Divisi Petugas</label>
                            ...
                            <div>
                                <label class="text-muted small">Catatan Petugas</label>
                    ...
                    <div class="row g-3">
                        @foreach($lampiranList as $index => $lampiranPath)
                            @php
                                ...
                                // Pastikan path benar - jika sudah ada 'storage/' di awal, hapus
                ...
                <!-- Lampiran Response (jika sudah ditanggapi) -->
                @php
                ...
                <!-- Form Tanggapan (untuk petugas/admin) -->
                @php
                    $user = auth()->user();
                    $divisionId = $user->division_id;
                    $isSuratMasuk = $divisionId && $letter->penerima_division_id == $divisionId;
                    $isSuratKeluar = $letter->pengirim && $letter->pengirim->division_id == $divisionId;
                    // Hanya bisa respond jika surat MASUK (bukan surat keluar) dan status masih pending
                    $canRespond = $isSuratMasuk && !$isSuratKeluar && $letter->status === 'pending';
                @endphp
                @if(in_array($user->role, ['admin', 'petugas']) && $canRespond)
