...
<div class="mb-4">
    ...
    <p class="text-muted">Kirim surat untuk pertemuan individu ke divisi lain</p>
</div>
        ...
        <form action="{{ route('surat_masuk.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control" value="Pertemuan Individu" readonly disabled>
                    <input type="hidden" name="jenis" value="pertemuan_individu" id="jenis">
                    <small class="form-text text-muted">
                        <i class="bi bi-info-circle"></i> User hanya dapat membuat surat jenis Pertemuan Individu
                    </small>
                    @error('jenis')
            ...
            <!-- Form Pilih Nama (muncul setelah divisi dipilih) -->
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function loadUsersByDivision(divisionId) {
            ...
            fetch(`/api/users-by-division/${divisionId}`, {
                ...
                .then(users => {
                    ...
                    // Tampilkan container jika jenis adalah pertemuan_individu
        ...
        function togglePilihNama() {
            ...
            // Karena user hanya bisa membuat pertemuan individu, langsung tampilkan form pilih nama saat divisi dipilih
            if (hasDivision) {
                pilihNamaContainer.style.display = 'block';
                penerimaUserId.required = true;
