    ...
    <div class="d-flex justify-content-between align-items-center">
        <div>
            ...
            <p class="text-muted mb-0">
                ...
                @else
                    Surat yang ditujukan kepada Anda
                @endif
            </p>
        </div>
        @if($tab === 'keluar')
...
<ul class="nav nav-tabs mb-4" role="tablist">
    <li class="nav-item" role="presentation">
        <form action="{{ route('user.surat_masuk.tab') }}" method="POST" class="d-inline">
            @csrf
                    ...
                    <tr>
                        ...
                        <td>
                            @if($letter->jenis === 'pertemuan_individu' && $letter->penerimaUser)
                                <i class="bi bi-person text-muted"></i> {{ $letter->penerimaUser->name }}<br>
                                <small class="text-muted">
                                    <i class="bi bi-building"></i> {{ $letter->penerimaDivision->name ?? '-' }}
                                </small>
                            @else
                        ...
                        <td>
                            ...
                            <span class="badge bg-warning"><i class="bi bi-clock-history"></i> Menunggu</span>
                    ...
                    <tr>
                        <td colspan="{{ $tab === 'keluar' ? '7' : '8' }}" class="text-center py-5">
                            ...
                            <p class="text-muted mt-3 mb-2">
                                ...
                                @else
                                    Belum ada surat yang ditujukan kepada Anda
                                @endif
                            </p>
                            @if($tab === 'keluar')
